...
export const createUserSchema = z
  .object({
    ...
    role: z.enum(['system_admin', 'warehouse_manager', 'storekeeper', 'accountant', 'department_manager', 'viewer'], {
...
export const updateUserSchema = z.object({
  ...
  role: z.enum(['system_admin', 'warehouse_manager', 'storekeeper', 'accountant', 'department_manager', 'viewer']).optional(),
